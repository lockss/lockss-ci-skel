...
Export the necessary keys and encrypt them travis making note of the openssl aes256
...
Edit the before_deploy.sh script and replace SOME value with the one from encrypt file.
```
